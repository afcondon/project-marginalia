...
(() => {
  ...
  var bindExceptT = function(dictMonad) {
    ...
    return {
      bind: function(v2) {
        return function(k) {
          return bind6(v2)(either(function($193) {
  ...
  // output/Finance.App/foreign.js
  var parseSubscriptions_ = (str) => {
    try {
      const d = JSON.parse(str);
      return {
        subscriptions: (d.subscriptions || []).map((s2) => ({
          id: s2.id || 0,
          name: s2.name || "",
          category: s2.category || "",
          amount: s2.amount || 0,
          currency: s2.currency || "EUR",
          frequency: s2.frequency || "monthly",
          nextDue: s2.nextDue || "",
          notes: s2.notes || ""
        })),
  ...
  var request = function(driver2) {
    return function(req) {
      ...
      var extractContent = function(v3) {
        ...
        ;
        if (v3 instanceof Document2) {
          return new Right(unsafeToForeign(v3.value0));
        }
        ;
        if (v3 instanceof $$String2) {
          return new Right(unsafeToForeign(v3.value0));
        }
        ;
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v2) {
    var go2 = function(v22) {
      ...
      if (v22 instanceof Keyed) {
        return new Keyed(v22.value0, v22.value1, v2.value0(v22.value2), map8(map13(go2))(v22.value3));
      }
      ;
  ...
  var viewBox = function(x_) {
    return function(y_) {
      return function(w) {
        return function(h_) {
          return attr2("viewBox")(joinWith(" ")(map11(show4)([x_, y_, w, h_])));
        };
      };
    };
  };
  ...
  var summaryBlock = function(label5) {
    return function(value13) {
      return function(unit2) {
        return div2([class_("summary-block")])([div2([class_("summary-label")])([text(label5)]), div2([class_("summary-value")])([text(value13), span2([class_("summary-unit")])([text(unit2)])])]);
      };
    };
  };
  var renderTimelineHeader = /* @__PURE__ */ div2([/* @__PURE__ */ class_("timeline-header")])([/* @__PURE__ */ span2([/* @__PURE__ */ class_("timeline-label")])([/* @__PURE__ */ text("Subscription")]), /* @__PURE__ */ span2([/* @__PURE__ */ class_("timeline-label")])([/* @__PURE__ */ text("Monthly cost \xB7 cadence")]), /* @__PURE__ */ span2([/* @__PURE__ */ class_("timeline-label")])([/* @__PURE__ */ text("Amount")])]);
  var renderMasthead = /* @__PURE__ */ div2([/* @__PURE__ */ class_("finance-masthead")])([/* @__PURE__ */ h1([/* @__PURE__ */ class_("finance-title")])([/* @__PURE__ */ text("Finance")]), /* @__PURE__ */ span2([/* @__PURE__ */ class_("finance-subtitle")])([/* @__PURE__ */ text("The Cambrian Explosion")])]);
  var normalizeToMonthly = function(sub1) {
    if (sub1.frequency === "weekly") {
      return sub1.amount * 4.33;
    }
    ;
    if (sub1.frequency === "fortnightly") {
      return sub1.amount * 26 / 12;
    }
    ;
    if (sub1.frequency === "monthly") {
      return sub1.amount;
    }
    ;
    if (sub1.frequency === "quarterly") {
      return sub1.amount / 3;
    }
    ;
    if (sub1.frequency === "annual") {
      return sub1.amount / 12;
    }
    ;
    return sub1.amount;
  };
  var sortByMonthlyCost = /* @__PURE__ */ sortBy(function(a3) {
    return function(b2) {
      return compare2(normalizeToMonthly(b2))(normalizeToMonthly(a3));
    };
  });
  var monthlyCharges = function(sub1) {
    if (sub1.frequency === "monthly") {
      return replicate(12)(sub1.amount);
    }
    ;
    if (sub1.frequency === "fortnightly") {
      return replicate(12)(sub1.amount * 26 / 12);
    }
    ;
    if (sub1.frequency === "weekly") {
      return replicate(12)(sub1.amount * 4.33);
    }
    ;
    if (sub1.frequency === "annual") {
      return append5([sub1.amount])(replicate(11)(0));
    }
    ;
    if (sub1.frequency === "quarterly") {
      return [sub1.amount, 0, 0, sub1.amount, 0, 0, sub1.amount, 0, 0, sub1.amount, 0, 0];
    }
    ;
    return replicate(12)(sub1.amount);
  };
  var handleAction = function(dictMonadAff) {
    ...
    return function(v2) {
      return bind3(liftAff2(get3(string)("/api/subscriptions")))(function(result) {
        if (result instanceof Left) {
          return modify_3(function(s2) {
            var $35 = {};
            for (var $36 in s2) {
              if ({}.hasOwnProperty.call(s2, $36)) {
                $35[$36] = s2[$36];
              }
              ;
            }
        ...
        if (result instanceof Right) {
          var d = parseSubscriptions_(result.value0.body);
          return modify_3(function(s2) {
            var $39 = {};
            for (var $40 in s2) {
            ...
            ;
            $39.subs = d.subscriptions;
            $39.monthlyBurn = d.monthlyBurn;
            $39.loading = false;
            return $39;
          });
        }
        ;
        throw new Error("Failed pattern match at Finance.App (line 83, column 5 - line 87, column 99): " + [result.constructor.name]);
      });
    };
  };
  var freqLabel = function(v2) {
    if (v2 === "monthly") {
      return "mo";
    }
    ;
  ...
  var footerTotal = function(label5) {
    return function(value13) {
      return div2([class_("footer-total")])([span2([class_("footer-label")])([text(label5)]), span2([class_("footer-value")])([text(value13)])]);
    };
  };
  var fmt2 = /* @__PURE__ */ toStringWith(/* @__PURE__ */ fixed(2));
  var renderFooter = function(state3) {
    var yearly = state3.monthlyBurn * 12;
    var daily = state3.monthlyBurn / 30.44;
    return div2([class_("finance-footer")])([footerTotal("Monthly")(fmt2(state3.monthlyBurn)), footerTotal("Yearly")(fmt2(yearly)), footerTotal("Daily")(fmt2(daily))]);
  };
  var renderSummary = function(state3) {
    var yearly = state3.monthlyBurn * 12;
    var daily = state3.monthlyBurn / 30.44;
    return aside([class_("finance-summary")])([summaryBlock("Daily average")(fmt2(daily))("/day"), summaryBlock("Monthly")(fmt2(state3.monthlyBurn))("/mo"), summaryBlock("Yearly")(fmt2(yearly))("/yr"), summaryBlock("Subscriptions")(show5(length(state3.subs)))("active")]);
  };
  var denomBlock = function(amount) {
    var n = round2(amount);
    var $44 = n >= 1e3;
    if ($44) {
      return {
        count: min3(9)(round2(amount / 1e3)),
        color: "#8b2020"
      };
    }
    ;
    ...
    if ($45) {
      return {
        count: min3(9)(round2(amount / 100)),
        color: "#4a6fa5"
      };
    }
    ;
  ...
  var renderMonthBlocks = function(sub1) {
    var charges = monthlyCharges(sub1);
    var maxDots = foldl2(function(acc) {
      return function(charge) {
        var n = (function() {
          ...
          ;
          return denomBlock(charge).count;
        })();
        return max3(acc)(n);
      };
    })(0)(charges);
    var blockWidth = toNumber(3) * 7.5;
    var monthWidth = blockWidth + 5;
    var svgWidth = 12 * monthWidth;
    var maxRows = max3(1)(div1((maxDots + 3 | 0) - 1 | 0)(3));
    var blockHeight = toNumber(maxRows) * 7.5 + 2.8;
    var renderBlock = function(charge) {
      var $48 = charge < 0.5;
      if ($48) {
        return [];
      }
      ;
      var block = denomBlock(charge);
      return mapWithIndex2(function(i2) {
        return function(v2) {
          var r2 = div1(i2)(3);
          var c2 = mod2(i2)(3);
          return circle([cx(toNumber(c2) * 7.5 + 2.8), cy(toNumber(r2) * 7.5 + 2.8), r(2.8), fill(new Named(block.color))]);
        };
      })(replicate(block.count)(unit));
    };
    return svg([viewBox(0)(0)(svgWidth)(blockHeight + 2), attr2("class")("month-blocks-svg")])(concat(mapWithIndex2(function(monthIdx) {
      return function(charge) {
        var xOffset = toNumber(monthIdx) * monthWidth;
        var dots = renderBlock(charge);
        return map14(function(dot) {
          return g([transform([new Translate(xOffset, 0)])])([dot]);
        })(dots);
      };
    })(charges)));
  };
  var renderSubRow = function(sub1) {
    var monthlyCost = normalizeToMonthly(sub1);
    return div2([class_("sub-row cat-" + sub1.category)])([div2([class_("sub-row-left")])([div2([class_("sub-row-name")])([text(sub1.name)]), div2([class_("sub-row-category")])([text(sub1.category)])]), div2([class_("sub-row-center")])([renderMonthBlocks(sub1)]), div2([class_("sub-row-right")])([div2([class_("sub-row-amount")])([text(fmt2(sub1.amount) + (" " + sub1.currency))]), div2([class_("sub-row-freq")])([text("/" + freqLabel(sub1.frequency))]), div2([class_("sub-row-monthly")])([text("\u2248 " + (fmt2(monthlyCost) + "/mo"))])])]);
  };
  var render = function(state3) {
    return div2([class_("finance-app")])([renderMasthead, (function() {
      if (state3.loading) {
        return div2([class_("finance-loading")])([text("Loading...")]);
      }
      ;
      return div2([class_("finance-layout")])([div2([class_("timeline-area")])([renderTimelineHeader, div_(map14(renderSubRow)(sortByMonthlyCost(state3.subs))), renderFooter(state3)]), renderSummary(state3)]);
    })()]);
  };
  ...
  var evalQ = function(render2) {
    return function(ref2) {
      return function(q3) {
        return bind12(liftEffect4(read(ref2)))(function(v2) {
          return evalM(render2)(ref2)(v2["component"]["eval"](new Query(map18(Just.create)(liftCoyoneda(q3)), $$const(Nothing.value))));
        });
      };
    };
  };
          ...
          return function(cqb) {
            return bind12(liftEffect4(read(ref2)))(function(v1) {
              return unChildQueryBox(function(v22) {
                ...
                return map19(v22.value2)(sequential2(v22.value0(applicativeParAff)(evalChild)(v1.children)));
              })(cqb);
            });
          };
        };
      ...
      return function(i2) {
        ...
        var render2 = function(lchs) {
          return function($$var2) {
            return function __do2() {
              var v2 = read($$var2)();
              var shouldProcessHandlers = map20(isNothing)(read(v2.pendingHandlers))();
