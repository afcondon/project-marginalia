...
(() => {
  ...
  var STORAGE_KEY = "marginalia-capture-project-id";
  var getStoredProjectId_ = () => {
    try {
  ...
  var setStoredProjectId_ = (id3) => () => {
    try {
      localStorage.setItem(STORAGE_KEY, String(id3));
    } catch {
    }
  };

  // output/Capture.API/foreign.js
  var escapeJson = (s) => s.replace(/\\/g, "\\\\").replace(/"/g, '\\"').replace(/\n/g, "\\n").replace(/\r/g, "\\r").replace(/\t/g, "\\t");
  ...
  var decodeProjectSummary = function(json) {
  ...
  var decodeProjectList = function(json) {
    return bind2(toObject(json))(function(obj) {
      return bind2(lookup("projects")(obj))(function(projsJson) {
        return bind2(toArray(projsJson))(function(arr) {
          return traverse3(decodeProjectSummary)(arr);
        });
      });
    });
  };
  var fetchProjects = /* @__PURE__ */ bind12(/* @__PURE__ */ get3(string2)("/api/projects"))(function(result) {
    ...
    if (result instanceof Right) {
      ...
      ;
      if (v instanceof Right) {
        var v1 = decodeProjectList(v.value0);
        if (v1 instanceof Nothing) {
          return pure12([]);
        }
        ;
        ...
        ;
        throw new Error("Failed pattern match at Capture.API (line 49, column 21 - line 51, column 27): " + [v1.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Capture.API (line 47, column 19 - line 51, column 27): " + [v.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Capture.API (line 45, column 3 - line 51, column 27): " + [result.constructor.name]);
  });
  var addNote = function(projectId) {
    return function(content3) {
      ...
      var body2 = '{"content":' + (quote(content3) + ',"author":"capture"}');
      return bind12(post2(string2)("/api/agent/projects/" + (show2(projectId) + "/notes"))(new Just(string(body2))))(function(result) {
        return pure12(isRight(result));
      });
    };
  };
  ...
  var coerce3 = function(fn) {
    ...
    })(identity7)(runExcept(alt3(unsafeReadTagged3("Error")(fn))(map9(error)(readString2(fn)))));
  };
  ...
  var Dictating = /* @__PURE__ */ (function() {
    ...
    ;
    Dictating2.value = new Dictating2();
    return Dictating2;
  })();
  var DictateReview = /* @__PURE__ */ (function() {
    function DictateReview2(value0) {
      this.value0 = value0;
    }
    ;
    DictateReview2.create = function(value0) {
      return new DictateReview2(value0);
    };
    return DictateReview2;
  })();
  var Writing = /* @__PURE__ */ (function() {
    function Writing2() {
    }
    ;
    Writing2.value = new Writing2();
    return Writing2;
  })();
  var PastingUrl = /* @__PURE__ */ (function() {
    function PastingUrl2() {
    }
    ;
    PastingUrl2.value = new PastingUrl2();
    return PastingUrl2;
  })();
  ...
  var OpenPicker = /* @__PURE__ */ (function() {
    ...
    ;
    OpenPicker2.value = new OpenPicker2();
    return OpenPicker2;
  })();
  var ClosePicker = /* @__PURE__ */ (function() {
    function ClosePicker2() {
    }
    ;
    ClosePicker2.value = new ClosePicker2();
    return ClosePicker2;
  })();
  var SetPickerSearch = /* @__PURE__ */ (function() {
    function SetPickerSearch2(value0) {
      this.value0 = value0;
    }
    ;
    SetPickerSearch2.create = function(value0) {
      return new SetPickerSearch2(value0);
    };
    return SetPickerSearch2;
  })();
  ...
  var StartDictate = /* @__PURE__ */ (function() {
    function StartDictate2() {
    }
    ;
    StartDictate2.value = new StartDictate2();
    return StartDictate2;
  })();
  var StopDictate = /* @__PURE__ */ (function() {
    function StopDictate2() {
    }
    ;
    StopDictate2.value = new StopDictate2();
    return StopDictate2;
  })();
  var SaveDictation = /* @__PURE__ */ (function() {
    function SaveDictation2() {
    }
    ;
    SaveDictation2.value = new SaveDictation2();
    return SaveDictation2;
  })();
  var RetryDictation = /* @__PURE__ */ (function() {
    function RetryDictation2() {
    }
    ;
    RetryDictation2.value = new RetryDictation2();
    return RetryDictation2;
  })();
  var SetTranscript = /* @__PURE__ */ (function() {
    function SetTranscript2(value0) {
      this.value0 = value0;
    }
    ;
    SetTranscript2.create = function(value0) {
      return new SetTranscript2(value0);
    };
    return SetTranscript2;
  })();
  var StartWrite = /* @__PURE__ */ (function() {
    function StartWrite2() {
    }
    ;
    StartWrite2.value = new StartWrite2();
    return StartWrite2;
  })();
  var SetNoteText = /* @__PURE__ */ (function() {
    function SetNoteText2(value0) {
      this.value0 = value0;
    }
    ;
    SetNoteText2.create = function(value0) {
      return new SetNoteText2(value0);
    };
    return SetNoteText2;
  })();
  var SaveNote = /* @__PURE__ */ (function() {
    ...
    ;
    SaveNote2.value = new SaveNote2();
    return SaveNote2;
  })();
  var StartUrl = /* @__PURE__ */ (function() {
    function StartUrl2() {
    }
    ;
    StartUrl2.value = new StartUrl2();
    return StartUrl2;
  })();
  var SetUrlText = /* @__PURE__ */ (function() {
    function SetUrlText2(value0) {
      this.value0 = value0;
    }
    ;
    SetUrlText2.create = function(value0) {
      return new SetUrlText2(value0);
    };
    return SetUrlText2;
  })();
  var SetUrlComment = /* @__PURE__ */ (function() {
    function SetUrlComment2(value0) {
      this.value0 = value0;
    }
    ;
    SetUrlComment2.create = function(value0) {
      return new SetUrlComment2(value0);
    };
    return SetUrlComment2;
  })();
  var SaveUrl = /* @__PURE__ */ (function() {
    function SaveUrl2() {
    }
    ;
    SaveUrl2.value = new SaveUrl2();
    return SaveUrl2;
  })();
  var CancelCapture = /* @__PURE__ */ (function() {
  ...
  var renderWriting = function(state3) {
    return div3([class_("capture-flow capture-write")])([textarea([class_("write-input"), value4(state3.noteText), placeholder2("Quick note..."), autofocus2(true), rows(4), onValueInput(SetNoteText.create)]), div3([class_("capture-actions")])([button([class_("capture-save"), disabled2(state3.saving || $$null2(trim(state3.noteText))), onClick(function(v) {
      ...
      ;
      return "Save";
    })())]), button([class_("capture-cancel"), onClick(function(v) {
      return CancelCapture.value;
    })])([text("Cancel")])])]);
  };
  var renderUrlCapture = function(state3) {
    return div3([class_("capture-flow capture-url")])([input([class_("url-input"), type_4(InputUrl.value), value4(state3.urlText), placeholder2("https://..."), autofocus2(true), onValueInput(SetUrlText.create)]), input([class_("url-comment"), type_4(InputText.value), value4(state3.urlComment), placeholder2("comment (optional)"), onValueInput(SetUrlComment.create)]), div3([class_("capture-actions")])([button([class_("capture-save"), disabled2(state3.saving || $$null2(trim(state3.urlText))), onClick(function(v) {
      return SaveUrl.value;
    })])([text((function() {
      if (state3.saving) {
        return "saving...";
      }
  ...
  var renderRecentCaptures = function(state3) {
    return div3([class_("recent-captures")])([div3([class_("recent-label")])([text("recent")]), div3([class_("recent-list")])(map16(renderRecentItem)(state3.recentCaptures))]);
  };
  var renderProjectStrip = function(state3) {
    return div3([class_("project-strip"), onClick(function(v) {
      return OpenPicker.value;
    })])([(function() {
      if (state3.currentProject instanceof Nothing) {
        return span2([class_("project-strip-empty")])([text("tap to pick a project")]);
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Capture.App (line 155, column 7 - line 166, column 14): " + [state3.currentProject.constructor.name]);
  ...
  var renderPickerItem = function(state3) {
    return function(p2) {
      var isCurrent = (function() {
        if (state3.currentProject instanceof Just) {
          return state3.currentProject.value0.id === p2.id;
        }
        ;
        if (state3.currentProject instanceof Nothing) {
          return false;
        ...
        ;
        throw new Error("Failed pattern match at Capture.App (line 259, column 19 - line 261, column 25): " + [state3.currentProject.constructor.name]);
      })();
      return div3([class_("picker-item" + (function() {
        if (isCurrent) {
          return " picker-item-current";
        }
        ;
        return "";
      })()), onClick(function(v) {
        return new SelectProject(p2);
      })])([span2([class_("domain-dot domain-" + p2.domain)])([]), span2([class_("picker-item-name")])([text(p2.name)]), span2([class_("picker-item-status")])([text(p2.status)])]);
    };
  };
  var renderPicker = function(state3) {
    var filtered = (function() {
      ...
      return filter(function(p2) {
        return contains(q2)(toLower(p2.name));
      })(state3.projects);
    })();
  ...
  var renderDictating = function(_state) {
    return div3([class_("capture-flow capture-dictate")])([div3([class_("dictate-indicator")])([span2([class_("dictate-dot")])([]), text("recording")]), button([class_("dictate-stop"), onClick(function(v) {
      return StopDictate.value;
    })])([text("tap to stop")])]);
  };
  var renderDictateReview = function(state3) {
    return function(transcript) {
      return div3([class_("capture-flow capture-dictate-review")])([textarea([class_("dictate-transcript"), value4(transcript), rows(5), onValueInput(SetTranscript.create)]), div3([class_("capture-actions")])([button([class_("capture-save"), disabled2(state3.saving), onClick(function(v) {
        return SaveDictation.value;
      })])([text((function() {
        if (state3.saving) {
          return "saving...";
        }
        ;
        return "Save";
      })())]), button([class_("capture-retry"), onClick(function(v) {
        return RetryDictation.value;
      })])([text("Retry")]), button([class_("capture-cancel"), onClick(function(v) {
        return CancelCapture.value;
      })])([text("Cancel")])])]);
    };
  };
  var renderCaptureFlow = function(state3) {
    return function(v) {
      if (v instanceof Dictating) {
        return renderDictating(state3);
      }
      ;
      if (v instanceof DictateReview) {
        return renderDictateReview(state3)(v.value0);
      }
      ;
      if (v instanceof Writing) {
        return renderWriting(state3);
      }
      ;
      if (v instanceof PastingUrl) {
        return renderUrlCapture(state3);
      }
      ;
      throw new Error("Failed pattern match at Capture.App (line 278, column 27 - line 282, column 39): " + [v.constructor.name]);
    };
  };
  var initialState = /* @__PURE__ */ (function() {
    return {
      projects: [],
      currentProject: Nothing.value,
      captureMode: Nothing.value,
      pickerOpen: false,
      pickerSearch: "",
      recording: false,
      transcript: "",
  ...
  var hasProject = function(state3) {
    ...
    ;
    throw new Error("Failed pattern match at Capture.App (line 201, column 20 - line 203, column 19): " + [state3.currentProject.constructor.name]);
  };
    ...
    return function(v) {
            ...
            return when2(storedId > 0)(bind5(get4)(function(state3) {
              ...
              if (v1 instanceof Just) {
                return modify_3(function(s) {
                  ...
                  ;
                  $93.currentProject = new Just(v1.value0);
                  return $93;
                });
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at Capture.App (line 399, column 7 - line 401, column 29): " + [v1.constructor.name]);
            }));
          });
        });
      }
      ...
      if (v instanceof SelectProject) {
        return discard2(liftEffect8(setStoredProjectId_(v.value0.id)))(function() {
          return modify_3(function(s) {
            ...
            ;
            $110.currentProject = new Just(v.value0);
            $110.pickerOpen = false;
            return $110;
          });
        });
      }
      ...
      if (v instanceof StartDictate) {
        return bind5(liftAff2(toAffE(startRecording_)))(function(started) {
          return when2(started)(modify_3(function(s) {
            ...
            ;
            $114.captureMode = new Just(Dictating.value);
            $114.recording = true;
            $114.error = Nothing.value;
            return $114;
          }));
        });
      }
        ...
        return bind5(liftAff2($$try4(toAffE(stopAndTranscribe_))))(function(result) {
          if (result instanceof Right) {
            return modify_3(function(s) {
              ...
              ;
              $118.captureMode = new Just(new DictateReview(result.value0));
              $118.recording = false;
              $118.transcript = result.value0;
              return $118;
            });
          }
          ;
          if (result instanceof Left) {
            return modify_3(function(s) {
              ...
              ;
              $122.captureMode = Nothing.value;
              $122.recording = false;
              $122.error = new Just("Transcription failed \u2014 is whisper running?");
              return $122;
            });
          }
          ;
          throw new Error("Failed pattern match at Capture.App (line 429, column 5 - line 441, column 12): " + [result.constructor.name]);
        });
      }
      ;
      if (v instanceof SetTranscript) {
        return modify_3(function(s) {
          ...
          ;
          $126.transcript = v.value0;
          $126.captureMode = new Just(new DictateReview(v.value0));
          return $126;
        });
      }
      ;
      if (v instanceof SaveDictation) {
        return bind5(get4)(function(state3) {
              ...
              return bind5(liftAff2(addNote(state3.currentProject.value0.id)(state3.transcript)))(function(ok) {
                if (ok) {
                  ...
                  return modify_3(function(s) {
                    ...
                    ;
                    $135.captureMode = Nothing.value;
                    $135.saving = false;
                    $135.transcript = "";
                    $135.recentCaptures = cons(cap)(take(9)(s.recentCaptures));
                    return $135;
                  });
                }
                ;
                return modify_3(function(s) {
                  ...
                  ;
                  $138.saving = false;
                  $138.error = new Just("Failed to save note");
                  return $138;
                });
              });
            });
          ...
          ;
          throw new Error("Failed pattern match at Capture.App (line 448, column 5 - line 460, column 88): " + [state3.currentProject.constructor.name]);
        });
      }
      ;
      if (v instanceof RetryDictation) {
        return bind5(liftAff2(toAffE(startRecording_)))(function(started) {
          return when2(started)(modify_3(function(s) {
            ...
            ;
            $142.captureMode = new Just(Dictating.value);
            $142.recording = true;
            $142.transcript = "";
            return $142;
          }));
      ...
      if (v instanceof StartWrite) {
        return modify_3(function(s) {
          ...
          ;
          $145.captureMode = new Just(Writing.value);
          $145.noteText = "";
          $145.error = Nothing.value;
          return $145;
        });
      }
      ;
      ...
      if (v instanceof SaveNote) {
        return bind5(get4)(function(state3) {
              ...
              return bind5(liftAff2(addNote(state3.currentProject.value0.id)(text6)))(function(ok) {
                if (ok) {
                  ...
                  return modify_3(function(s) {
                    ...
                    ;
                    $157.captureMode = Nothing.value;
                    $157.saving = false;
                    $157.noteText = "";
                    $157.recentCaptures = cons(cap)(take(9)(s.recentCaptures));
                    return $157;
                  });
                }
                ;
                return modify_3(function(s) {
                  ...
                  ;
                  $160.saving = false;
                  $160.error = new Just("Failed to save note");
                  return $160;
                });
              });
            }));
          ...
          ;
          throw new Error("Failed pattern match at Capture.App (line 476, column 5 - line 490, column 90): " + [state3.currentProject.constructor.name]);
        });
      }
      ;
      if (v instanceof StartUrl) {
        return modify_3(function(s) {
          ...
          ;
          $164.captureMode = new Just(PastingUrl.value);
          $164.urlText = "";
          $164.urlComment = "";
          $164.error = Nothing.value;
          return $164;
        });
      }
      ;
      ...
      if (v instanceof SaveUrl) {
        return bind5(get4)(function(state3) {
          ...
          if (state3.currentProject instanceof Just) {
            ...
            return when2(!$$null2(url))((function() {
              var body2 = url + (function() {
                var $176 = $$null2(trim(state3.urlComment));
                if ($176) {
                  return "";
                }
                ;
                ...
                return bind5(liftAff2(addNote(state3.currentProject.value0.id)(body2)))(function(ok) {
                  if (ok) {
                    ...
                    return modify_3(function(s) {
                      ...
                      ;
                      $181.captureMode = Nothing.value;
                      $181.saving = false;
                      $181.urlText = "";
                      $181.urlComment = "";
                      $181.recentCaptures = cons(cap)(take(9)(s.recentCaptures));
                      return $181;
                    });
                  }
                  ;
                  return modify_3(function(s) {
                    ...
                    ;
                    $184.saving = false;
                    $184.error = new Just("Failed to save URL");
                    return $184;
                  });
                });
              });
          ...
          ;
          throw new Error("Failed pattern match at Capture.App (line 504, column 5 - line 519, column 89): " + [state3.currentProject.constructor.name]);
        });
      }
      ;
      ...
      ;
      throw new Error("Failed pattern match at Capture.App (line 392, column 16 - line 522, column 130): " + [v.constructor.name]);
    };
  };
    ...
    return function(label5) {
      return function(action2) {
        return function(enabled) {
          return button([class_("capture-btn capture-btn-" + cls), disabled2(!enabled), onClick(function(v) {
            return action2;
          })])([span2([class_("capture-btn-label")])([text(label5)])]);
        };
      };
    };
  };
  var renderHome = function(state3) {
    return div3([class_("capture-home")])([div3([class_("capture-buttons")])([captureButton("dictate")("Dictate")(StartDictate.value)(hasProject(state3)), captureButton("write")("Write")(StartWrite.value)(hasProject(state3)), captureButton("url")("URL")(StartUrl.value)(hasProject(state3))]), (function() {
      var $191 = $$null(state3.recentCaptures);
      if ($191) {
        return text("");
      }
      ;
      return renderRecentCaptures(state3);
    })(), (function() {
      ...
      ;
      throw new Error("Failed pattern match at Capture.App (line 183, column 7 - line 186, column 28): " + [state3.error.constructor.name]);
    })()]);
  };
  var render = function(state3) {
    return div3([class_("capture-app")])([renderProjectStrip(state3), (function() {
      ...
      ;
      throw new Error("Failed pattern match at Capture.App (line 143, column 7 - line 145, column 50): " + [state3.captureMode.constructor.name]);
    })()]);
  };
